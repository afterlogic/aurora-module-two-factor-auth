 ...
 * complete 2FA setup/login without a human. No external dependency — Node
 * `crypto` only.
 *
 * Mirrors modules/TwoFactorAuth/vue-mobile/test/e2e/helpers/totp.js — kept as
 * a separate copy since desktop/next E2E and mobile E2E run under different
 * Playwright roots (AURORA_E2E_ROOT vs AURORA_MOBILE_E2E_ROOT).
 */
